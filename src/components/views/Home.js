...
function Home() {
  ...
  return (
    <div className=" grid gap-y-8">
      <RowGroup title="Recently Played" more="/blabla" items={items} />
      <RowGroup title="Shows to try" more="/blabla" items={items} />
      <RowGroup title="Made For Mustafa Kalaycı" more="/blabla" items={items} />
    </div>
  );
}
